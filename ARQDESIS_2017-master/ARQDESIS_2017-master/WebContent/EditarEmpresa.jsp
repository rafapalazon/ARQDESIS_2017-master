		...
		<form action="ManterEmpresa" method="post">
			...
			<div class="row">
				<div class="form-group col-md-8">
					<label for="razaoSocial">Razão Social</label> <input type="text"
						...
						maxlength="45" value="${razaoSocial }"
						pattern="[a-zA-Z0-9!@#$%&*-_+= .;,!?/ãâáàÁÀÃéèêÉÈÊíìÍÌõóòÕÓÒúùÚÙçÇ]{6,45}"
						required>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-8">
					<label for="nomeFantasia">Nome Fantasia</label> <input type="text"
						...
						maxlength="45" value="${empresa.nomeFantasia }"
						pattern="[a-zA-Z0-9!@#$%&*-_+= .;,!?/ãâáàÁÀÃéèêÉÈÊíìÍÌõóòÕÓÒúùÚÙçÇ]{6,45}">
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-7">
					<label for="conjuntos">Conjunto</label>
					<c:forEach var="conjuntosVagos" items="${conjuntosVagos}">
						<input type="checkbox" name="conjuntos"
							value="${conjuntosVagos.numeroConjunto}">${conjuntosVagos.numeroConjunto} 
					</c:forEach>
			...
			<div class="row">
				<div class="form-group col-md-3">
					<label for="cnpj">CNPJ</label> <input type="text"
						...
						pattern="\d{14}" value="${empresa.cnpj }" required>
				</div>
			...
			<div class="row">
				...
				<div class="form-group col-md-8">
					<label for="horarioFim">Horário de Saída</label>
					<form class="form-horizontal">
						<div class="form-group">
							<div class="col-md-2">
				...
				<div class="form-group col-md-8">
					<label for="horLigarAC">Ligar Ar</label>
					<form class="form-horizontal">
						<div class="form-group">
							<div class="col-md-2">
								<select class="form-control col-md-2" type="text"
				...
				<div class="form-group col-md-8">
					<label for="horDesligarAC">Desligar Ar</label>
					<form class="form-horizontal">
						<div class="form-group">
							<div class="col-md-2">
								<select class="form-control col-md-2" type="text"
